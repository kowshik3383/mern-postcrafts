...
function Signup() {
  const navigate = useNavigate(); // Use a shorter variable name
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post('https://server-4-muw9.onrender.com/api/signup', formData);
      console.log('Signup Successful:', response.data);
      navigate('/sign-in'); // Redirect to signin page on successful signup
    } catch (error) {
